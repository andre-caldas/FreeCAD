...
#include "ConstraintCoincidentPy.h"
#include "ConstraintCoincidentPy.cpp"


using namespace Sketcher;

PyObject *ConstraintCoincidentPy::PyMake(struct _typeobject*, PyObject* /*args*/, PyObject* /*kwd*/)
{
    // create a new instance of ConstraintCoincidentPy and the Twin object
    return new ConstraintCoincidentPy(new ConstraintCoincident);
}

// constructor method
int ConstraintCoincidentPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{
...
std::string ConstraintCoincidentPy::representation() const
{
...
Py::Object* ConstraintPy::addPoints(PyObject* args)
{
    for tuple...
// return self;
}

Py::Object* ConstraintPy::removePoints(PyObject* args)
{
    for tuple...
// return self;
}
...
PyObject *ConstraintCoincidentPy::getCustomAttributes(const char* /*attr*/) const
{
    return nullptr;
}

int ConstraintCoincidentPy::setCustomAttributes(const char* /*attr*/, PyObject* /*obj*/)
{
    return 0;
}
