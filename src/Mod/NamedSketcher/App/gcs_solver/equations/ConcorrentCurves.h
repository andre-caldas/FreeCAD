...
#ifndef NAMEDSKETCHER_GCS_ConcorrentCurves_H
#define NAMEDSKETCHER_GCS_ConcorrentCurves_H
...
class NamedSketcherExport ConcorrentCurves : public NonLinearEquation
{
public:
    ConcorrentCurves() = default;
...
#endif // NAMEDSKETCHER_GCS_ConcorrentCurves_H
