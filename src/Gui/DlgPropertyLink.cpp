        ...
        App::DocumentObject *obj, const char *subname, bool *pfound)
{
    ...
    for(auto o : sobjs) {
        ...
        for(int i=0,count=item->childCount();i<count;++i) {
            ...
            if(strcmp(o->_getNameInDocument(),
    ...
    try {
        ...
        if(select) {
            ...
            Gui::Selection().addSelection(obj->getDocument()->getName(),
                    obj->_getNameInDocument(),subname);
        }else{
            Selection().setPreselect(obj->getDocument()->getName(),
                    obj->_getNameInDocument(), subname, 0, 0, 0,
        ...
        App::DocumentObject *obj, QTreeWidgetItem *parent)
{
    ...
    item->setData(0, Qt::UserRole, QByteArray(obj->_getNameInDocument()));
